...
# ------------------------------------- 21Feb2023 ------------------------------------- #
# ResNet for Cifar-10 with ReLU activation
...
def ResNet101(num_channels=3, num_classes=10):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_channels=num_channels, num_classes=num_classes)


def ResNet152(num_channels=3, num_classes=10):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_channels=num_channels, num_classes=num_classes)
